...
class _OverviewSection extends StatelessWidget {
  ...
  build(ctx) {
    ...
    return VBox(mix: Mix(align(Alignment.topLeft), gap(10), pt(20)), children: [
      ...
      Text("The Arab Individual Chess Championship will take place from February 26th to March 5th in Khartoum, Sudan as a 9-round Swiss.\n\nTime control is 90 minutes for the entire game with a 30-second increment beginning from move 1.", style: theme.textTheme.bodyMedium),
